/**
 * File: f:\vue\jswei.cn\src\components\vue-alert-loading.vue
 * Created Date: 2017-12-25 9:14:29
 * Author: 魏巍
 * -----
 * Last Modified: 魏巍
...
.cpt-loading-mask.col .div-loading {
  position: absolute;
  top: 50%;
  left: 50%;
  width: 260px;
...
.cpt-loading-mask.col .div-loading .loading {
  position: relative;
  width: 60px;
  height: 60px;
  background: transparent;
...
.cpt-loading-mask.col .div-loading .loading.origin div {
  width: 80%;
  height: 80%;
  position: absolute;
  left: 10%;
...
.cpt-loading-mask.col .div-loading .loading.origin div span {
...
.cpt-loading-mask.col .div-loading .loading.origin div:nth-child(1) {
  -moz-animation-delay: 0.2s;
  -webkit-animation-delay: 0.2s;
  animation-delay: 0.2s;
}
/* line 75, ../sass/loading.scss */
.cpt-loading-mask.col .div-loading .loading.origin div:nth-child(2) {
  -moz-animation-delay: 0.4s;
  -webkit-animation-delay: 0.4s;
  animation-delay: 0.4s;
}
/* line 78, ../sass/loading.scss */
.cpt-loading-mask.col .div-loading .loading.origin div:nth-child(3) {
  -moz-animation-delay: 0.6s;
  -webkit-animation-delay: 0.6s;
  animation-delay: 0.6s;
}
/* line 81, ../sass/loading.scss */
.cpt-loading-mask.col .div-loading .loading.origin div:nth-child(4) {
  -moz-animation-delay: 0.8s;
  -webkit-animation-delay: 0.8s;
  animation-delay: 0.8s;
}
/* line 84, ../sass/loading.scss */
.cpt-loading-mask.col .div-loading .loading.origin div:nth-child(5) {
  -moz-animation-delay: 1s;
  -webkit-animation-delay: 1s;
  animation-delay: 1s;
}
/* line 90, ../sass/loading.scss */
.cpt-loading-mask.col .div-loading .loading.pic {
  width: 80px;
  height: 80px;
}
/* line 94, ../sass/loading.scss */
.cpt-loading-mask.col .div-loading .loading.pic img {
  width: 100%;
  height: 100%;
}
/* line 101, ../sass/loading.scss */
.cpt-loading-mask.col .div-loading .loading-title {
  width: 100%;
  text-align: center;
  color: #fff;
  padding: 2px 0;
